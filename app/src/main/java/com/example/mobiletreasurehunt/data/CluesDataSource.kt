    ...
    fun loadClues(): List<Clue>{
        return listOf(
            Clue(
                ...
                clueHint = listOf(R.string.hint1_circa1800, R.string.clue1_circa1800), //R.string.hint1_circa1800,
            ...
            Clue(
                ...
                clueHint = listOf(R.string.hint1_sweetpalette, R.string.clue2_sweetpalette),
